    ...
    <section className="text-gray-800 antialiased">
      <div className="container relative mx-auto flex flex-col space-y-8 px-6">
        ...
        <div className="relative z-10">
          ...
          />
          <div className="xs:pl-28 xs:pt-0 relative pt-2 md:ml-auto md:w-1/2 md:pl-16"> <div className="xs:pl-28 xs:pt-0 relative pt-2 md:ml-0 md:mr-auto md:w-1/2 md:pl-0 md:pr-16"></div>
            <div
              ...
              <div className="mt-4 pl-4 pt-1 text-gray-400">
                <ul className="list-disc">
                  <li>
                    ...
                    Prisma, and Tailwind CSS to develop dynamic web applications
                    with robust code, efficient databases, and appealing
                    interfaces.
                  </li>
                  ...
                  <li>
                    Consistently delivering visually appealing, responsive user
                    interfaces by combining technical skills with user-centric
                    design principles.
                  </li>
                  <li>
                    Collaborating within teams, fostering success through open
                    communication and the integration of diverse perspectives to
          ...
          <div className="xs:pl-28 xs:pt-0 relative pt-2 md:ml-0 md:mr-auto md:w-1/2 md:pl-0 md:pr-16">
            ...
            <div className="cursor-pointer rounded-md p-6 shadow-xl backdrop-blur-md hover:shadow-2xl">
              ...
              <div className="mt-4 pl-4 pt-1 text-gray-400">
                <ul className="list-disc">
                  <li>
                    Educating students beginner to intermediate programming and
                    problem solving skills, breaking down how to solve complex
                    exercises in high level languages such as Python.
                  </li>
                  ...
                  <li>
                    Providing expert advice and recommendations on best practice
                    for students on problem solving.
                  </li>
                  <li>
                    Responsible for managing student development and growth
        ...
        <div className="relative z-10">
          ...
          <div className="xs:pl-28 xs:pt-0 relative pt-2 md:ml-auto md:w-1/2 md:pl-16">
            <div
              className="xs:top-11 xs:left-26 absolute inset-0 left-10 h-4 w-4 rotate-45 transform shadow-xl backdrop-blur-md md:left-14"
              aria-hidden="true"
            ></div>
            <div className="cursor-pointer rounded-md p-6 shadow-xl backdrop-blur-md hover:shadow-2xl">
              <span className="text-sm font-bold tracking-wide text-indigo-600">
              ...
              <p className="mt-4 pt-1 text-gray-400">
                Delivery, liased with office coordinate office assistants to
                ensure appropriate number of accurate materials. Use software to
                keep track of materials. Organised all returns. Ensured quality
                assurance by liaising with multiple teams to cross check votes
                due to the electorate being classified as closely contested.
                Communicated with team members to ensure an efficient election
                process.
              </p>
            </div>
          </div>
